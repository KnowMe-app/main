...
/**
 * Дволітерний код ролі — єдина позначка ролі на всіх екранах матчингу.
 *
 ...
 *
 * Словом роль тут більше не пишеться ніде. Слово залежало від мови інтерфейсу
 * й від місця показу — плашка в рядку казала «Донорка», відкрита картка
 * «Донорка яйцеклітин», фільтри «ДО», а англійською все це ставало «Donor», —
 * тож та сама роль називалась на екранах по-різному. Код однаковий скрізь і
 * перекладу не потребує. Повний підпис лишається в `getRoleLabel` — він і досі
 * розшифровує код там, де на розшифровку є місце й потреба.
 */
