...
describe('matching active-filter chips', () => {
  ...
  it('reads dropping only the no-data option as "лише заповнені"', () => {
    expect(buildMatchingFilterChipLabel(age, withOff(age, ['other'])))
      .toEqual({ text: 'Вік: лише заповнені', danger: false });
