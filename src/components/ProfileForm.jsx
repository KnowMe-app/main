  ...
  function downloadSearchKeySetsWritePreview({ accessUserId, rawRules, matchedUserIdsBySetKey, indexResult }) {
    try {
      ...
      const payload = {
        ...
        rawRules,
        matchedUserIdsBySetKey,
        backendWriteDebug: indexResult?.debug || {},
        summary: {
          setsCount: Number(indexResult?.setKeys?.length || 0),
          matchedUsersCount: Number(indexResult?.userIds?.length || 0),
          writesCount: Number(indexResult?.writesCount || 0),
          bucketWritesCount: Number(indexResult?.bucketWritesCount || 0),
        },
      };
