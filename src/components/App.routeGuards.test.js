 ...
 * інше в застосунку — про конкретних людей. Кожен з трьох нічого не читає з
 * бази (форма входу, текст угоди, зовнішня анкета подачі), тож і показувати
 * їх незалогіненому безпечно.
 */
const PUBLIC_ROUTES = ['/login', '/policy', '/submit'];
